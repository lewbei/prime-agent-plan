...
__all__ = [
    ...
    "symbol_audit", "scan_symbols", "parity_audit", "run_verification_commands",
    "parse_exit_criteria", "validate_exit_criteria", "run_exit_criteria",
    "ExecutionEvidence", "TaskExecution", "CommandResult", "parse_execution_evidence",
    "extract_declared_obligations", "align_task_evidence", "verify_execution_trace",
    "verify_negative_constraints", "RoTRuleBase", "RoTRule", "ReplanningLadder", "ContextBudgeter",
